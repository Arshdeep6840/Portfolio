  ...
  <div className="relative w-[290px] h-[150px]">
    ...
    />
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="#education" className="hover:underline text-sm font-medium">Education</a>
          <a href="#projects" className="hover:underline text-sm font-medium">Projects</a>
          <a href="#contact" className="hover:underline text-sm font-medium">Contact</a>
      ...
      <section className="text-center mb-20">
        ...
        <p className="mt-2 text-md text-opacity-70">Cleaning and Transforming data into actionable intelligence</p>
        <div className="flex justify-center gap-6 mt-4">
          <motion.a whileHover={{ scale: 1.1 }} href="https://github.com/arshdeep6840" target="_blank" className="hover:text-white transition"><Github size={24} /></motion.a>
          <motion.a whileHover={{ scale: 1.1 }} href="https://www.linkedin.com/in/arshdeep-singh-python-/" target="_blank" className="hover:text-white transition"><Linkedin size={24} /></motion.a>
          <motion.a whileHover={{ scale: 1.1 }} href="mailto:arshdeepsingh17092@gmail.com" className="hover:text-white transition"><Mail size={24} /></motion.a>
        </div>
        <motion.div whileHover={{ scale: 1.05 }} className="mt-6">
          <Button className="px-6 py-2 text-lg shadow-lg bg-white text-blue-800 hover:bg-blue-100 transition-all" asChild>
      ...
      {/* About Me */}
      <motion.section id="about" className="max-w-3xl mx-auto mb-20 scroll-mt-24" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
        <h2 className="text-3xl font-bold mb-4 text-center">About Me</h2>
        <p className="leading-relaxed text-center">
          I'm a data scientist with a passion for building scalable machine learning systems
          and delivering business value through data-driven solutions. My expertise spans data
          engineering, model development, and end-to-end MLOps. I thrive in collaborative,
          fast-paced environments where data becomes a strategic asset.
        </p>
      </motion.section>
...
<motion.section
  ...
  viewport={{ once: true }}
>
  <h2 className="text-3xl font-bold mb-8 text-center scroll-mt-24">Education</h2>

  <div className="">
    {[
      {
        degree: "Bachelor of Vocational in Software Development",
        institution: "Guru Nanak College, Budhlada (Punjab)",
        duration: "2022 – 2025",
        status: "Ongoing",
        courses: "Programming, Data Structures, Probability, Database Systems",
      },
    ].map((edu, index) => (
      <motion.div
        key={index}
      ...
      >
        ...
        <p className="text-sm opacity-80 mb-2"><a href="https://www.gncbudhlada.org/">{edu.institution}</a></p>
        {edu.status && <p className="text-sm text-gray-400 mb-2">{edu.status}</p>}
      ...
      {/* Certifications */}
      <motion.section className="max-w-4xl mx-auto mb-20 scroll-mt-24" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
      ...
      {/* Projects */}
      <motion.section id="projects" className="max-w-6xl mx-auto mb-20 scroll-mt-24" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
      ...
      {/* Contact */}
      <motion.section id="contact" className="max-w-2xl mx-auto text-center mb-10" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
      ...
      {/* Footer */}
      <footer className="text-center text-sm opacity-70 mt-16">© 2024 Arshdeep Singh. All rights reserved.</footer>
    </main>
  );
}
